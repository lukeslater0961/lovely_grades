...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { date: @grade.date, grade: @grade.grade, subject: @grade.subject, term: @grade.term } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { date: @grade.date, grade: @grade.grade, subject: @grade.subject, term: @grade.term } }
